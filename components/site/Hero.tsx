      ...
      <div className="container grid items-center gap-12 lg:grid-cols-12">
        ...
        <div className="lg:col-span-6 xl:col-span-6">
          ...
          <motion.div
            ...
            className="mt-10 flex flex-wrap items-center gap-6 text-xs text-brand-muted"
          >
...
function HeroVisual({ reduce }: { reduce: boolean }) {
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto aspect-[5/6] w-full max-w-[520px]"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -left-4 top-10 w-[240px] rounded-3xl border border-black/5 bg-white p-5 shadow-[0_22px_60px_-25px_rgba(10,10,10,0.3)] md:-left-10"
      >
      ...
      <motion.div
        ...
        className="absolute -right-4 bottom-14 w-[270px] rounded-3xl border border-black/5 bg-white p-5 shadow-[0_22px_60px_-25px_rgba(10,10,10,0.3)] md:-right-10"
      >
        <div className="flex items-center gap-2">
      ...
      <motion.div
        ...
        className="absolute -bottom-4 left-8 inline-flex items-center gap-2.5 rounded-full border border-black/5 bg-white/95 px-3.5 py-2 text-[11.5px] font-medium text-brand-ink shadow-card backdrop-blur md:left-4"
      >
